...
export class AppointmentsController {
  constructor(private prisma: PrismaService, private policy: PolicyService) {}
  ...
  async create(@Body() body: any) {
    ...
    await this.prisma.event.create({
      data: { tenantId, actorId: clientId, type: 'BookingCreated', payload: { appointmentId: appt.id, serviceId, price }, occurredAt: new Date() }
    });
