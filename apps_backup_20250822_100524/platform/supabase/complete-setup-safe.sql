-- ==========================================
-- LEA AESTHETICS ACADEMY - SAFE SUPABASE SETUP
-- This script handles existing dependencies safely
-- Safe to run on databases with existing objects
-- ==========================================
...
-- Drop existing functions (safe - won't conflict with policies)
...
-- ==========================================
-- HELPER FUNCTIONS FOR RLS (CREATE OR REPLACE TO AVOID CONFLICTS)
-- ==========================================

-- Get current user's role (safe to recreate)
...
-- Check if user is admin (safe to recreate)
...
SELECT 'Safe Supabase setup completed successfully!' as result,
       'Schema, triggers, and functions are all configured without breaking existing policies.' as details;
