...
interface IconProps {
  name: 'chevron-right' | 'calendar' | 'user' | 'check' | 'send' | 'sparkles' | 'message-circle';
  className?: string;
}
...
const ICONS: Record<IconProps['name'], React.ReactNode> = {
  ...
  'sparkles': <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m11-13l-1-1m2 0l-1 1m-2 11l-1-1m2 0l-1 1M12 21a9 9 0 110-18 9 9 0 010 18z" />,
